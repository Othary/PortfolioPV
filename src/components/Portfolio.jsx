...
const Portfolio= (autoSlide) => {
  ...
  useLayoutEffect(() =>{
    ...
    bgRef.current.className = ' absolute w-screen h-[80vh] sm:h-auto z-[5] blur-[3px] mix-blend-overlay';
    leftBgRef.current.className = 'absolute w-screen h-[80vh] sm:h-auto z-[4]  blur-[3px] mix-blend-overlay opacity-0';
    rightBgRef.current.className = 'absolute w-screen h-[80vh] sm:h-auto z-[4]  blur-[3px] mix-blend-overlay opacity-0';
  ...
  const onChangeSlide = (direction) => { 
    if (direction === "left") {
      ...
      bgRef.current.className = 'absolute h-[80vh] sm:h-auto z-[5] w-screen  blur-[3px] mix-blend-overlay opacity-0 duration-primaryDuration';
      leftBgRef.current.className = 'absolute h-[80vh] sm:h-auto z-[5] w-screen  blur-[3px] mix-blend-overlay animate-fade';      
      ...
      bgRef.current.className = 'absolute h-[80vh] sm:h-auto z-[5] w-screen  blur-[3px] mix-blend-overlay opacity-0 duration-primaryDuration';
      rightBgRef.current.className = 'absolute h-[80vh] sm:h-auto z-[5] w-screen  blur-[3px] mix-blend-overlay animate-fade';
